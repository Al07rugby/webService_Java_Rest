...
public class LigneCommandeFacadeREST extends AbstractFacade<LigneCommande> {
    ...
    private LigneCommandePK getPrimaryKey(PathSegment pathSegment) {
         ...
         * URI path part is supposed to be in form of 'somePath;commandeId=commandeIdValue;articleId=articleIdValue'.
         * Here 'somePath' is a result of getPath() method invocation and
         * it is ignored in the following code.
         * Matrix parameters are used as field names to build a primary key instance.
         */
        ecommerce.ws.server.entities.LigneCommandePK key = new ecommerce.ws.server.entities.LigneCommandePK();
        ...
        java.util.List<String> articleId = map.get("articleId");
        if (articleId != null && !articleId.isEmpty()) {
            key.setArticleId(new java.lang.Integer(articleId.get(0)));
        }
        return key;
    }
    ...
    public void remove(@PathParam("id") PathSegment id) {
        ecommerce.ws.server.entities.LigneCommandePK key = getPrimaryKey(id);
